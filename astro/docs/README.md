...
| [`adr/0014-byte-efficiency-of-the-streamed-corpus.md`](adr/0014-byte-efficiency-of-the-streamed-corpus.md) | Accepted — the corpus is transfer-bound; AR span-order replay (built, ~3x) and per-band tokenisation selected, concurrency fixes rejected. |
